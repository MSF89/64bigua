...
export const DatosTours = [
    ...
    }, 
    {
        ...
        tour: 'Glaciar Alternativo',
        duracion: '9 Horas',
        salidas: '7:30',
        precio: '$80000',
        link: 'https://walink.co/a163d1',
        incluye: 'Translado - guia',
        spanishDesc: 'Este tour te lleva a explorar el Glaciar Perito Moreno de manera única. Salimos temprano y tomamos una ruta alternativa, poco transitada para ver fauna y paisajes impresionantes. Haremos paradas en puntos estratégicos y visitaremos la emblematica Estancia Anita y el parador Rio Mitre donde podras tomar unos mates, cafe y tortas (No Incluido). Seguiremos avanzando hasta llegar a la entrada al Parque Nacional donde cada uno paga su entrada (no incluida) en la seccional Río Mitre.Luego, caminaremos por una senda exclusiva hasta la playa de los témpanos y disfrutaremos de vistas solitarias del glaciar. Un guía naturalista nos acompañará y explicará todo sobre el glaciar. Finalmente, regresaremos por la carretera convencional y llegaremos a Calafate aproximadamente a las 17:00 hs.',
        englishDesc: 'This tour takes you to explore the Perito Moreno Glacier in a unique way. We left early and took an alternative, less traveled route to see impressive fauna and landscapes. We will make stops at strategic points and visit the emblematic Estancia Anita and the Rio Miter parador where you can have some mates, coffee and cakes (Not Included). We will continue advancing until we reach the entrance to the National Park where everyone pays their entrance fee (not included) in the Río Miter section. Then, we will walk along an exclusive path to Iceberg Beach and enjoy solitary views of the glacier. A naturalist guide will accompany us and explain everything about the glacier. Finally, we will return along the conventional road and arrive in Calafate at approximately 5:00 p.m.',
        src1: "Alterna1",
        src2: "Alterna2",
        src3: "Alterna3",
    },
    ...
    {
        id: 'bosquePetrificado',
        imagen: 'bospe',
        icono: <HikingIcon/>,
        tour: 'Bosque Petrificado La Leona',
        duracion: ' 7 Horas',
        incluye: ' Translado - Guia - Vianda',
        salidas: '  9hs ',
        precio: "$180000",
        link: 'https://walink.co/a3ff00',
        spanishDesc: 'Es una Excursión de día entero en la zona de la estepa patagonica. Está orientada a las personas que les gustan las actividades al aire libre y la aventura, dispuestas a descubrir lugares nuevos... Este tour incluye aproximadamente 2 hs y media, de caminata discontinua en terreno irregular. La actividad comienza en El Calafate, recorriendo la ruta provincial 5 y ruta nacional 40, durante el trayecto podras ver el Lago Argentino, Rio Santa Cruz, Rio La Leona y su hermoso valle, con vista a la cordillera y el cerro Fitz Roy. Una parada de 15 minutos en el historico hotel La Leona, y continua el viaje hasta el Cerro Los Hornos Donde podran asomarse por primera vez a la enorme depresión del terreno en donde están los troncos petrificados y comenzar la caminata de exploración entre los fósiles. La actividad incluye Lunch box para disfrutar a mitad de camino, en medio del bosque. A lo largo de la caminata veremos gran cantidad de troncos petrificados que yacen en la superficie, testimonio de antiguas épocas en donde el clima era muy diferente al actual y permitía el soporte de una flora abundante y de grandes dimensiones. Ocasionalmente quedan al descubierto restos fósiles de distintos tipos de dinosaurios. El regreso comienza las 14:00hs aproximadamente con una nueva parada en el Hotel La Leona y arriba a Calafate alrededor de las 16:30hs. Se puede iniciar la excursion en El Chalten y regresar a Chalten o finalizar en Calafate, con los mismos horarios de salida y regreso al hotel.',
        englishDesc: 'It is a full day excursion in the Patagonian steppe area. It is aimed at people who like outdoor activities and adventure, willing to discover new places... This tour includes approximately 2 and a half hours of discontinuous walking on irregular terrain. The activity starts in El Calafate, traveling along provincial route 5 and national route 40, during the journey you will see the Lago Argentino, Rio Santa Cruz, Rio La Leona and its beautiful valley, with views of the mountain range and Mount Fitz Roy. A 15-minute stop at the historic La Leona hotel, and continue the trip to Cerro Los Hornos where you will be able to look for the first time at the enormous depression in the terrain where the petrified trunks are and begin the exploration walk among the fossils. The activity includes Lunch box to enjoy halfway, in the middle of the forest. Throughout the walk we will see a large number of petrified trunks lying on the surface, testimony to ancient times where the climate was very different from the current one and allowed the support of abundant and large flora. Fossil remains of different types of dinosaurs are occasionally discovered. The return starts at approximately 2pm with a new stop at the La Leona Hotel and arriving in Calafate around 4:30pm You can start the excursion in El Chalten and return to Chalten or end in Calafate, with the same departure and return times to the hotel.',
        src1: "bospe1",
        src2: "bospe2",
        src3: "bospe3",
    },
    ...
    },  
    {
        ...
        imagen:'cabal',
        icono: <LandscapeIcon/>,
        tour: 'Cabalgata Experience',
        duracion: '4hs',
        salidas: '10am',
        precio: "$150000",
        link: 'https://walink.co/5dd70b',
        incluye: 'Traslado - Cabalgata - Almuerzo',
        spanishDesc: 'Cabalgata Experience es una travesia a caballo por la reserva natural 25 de Mayo donde se puede sentir la inmensidad de los campos patagonicos, apreciar cañadones, arrollos e historias de los gauchos sureños. El punto de partida es el casco de la estancia 25 de Mayo donde se brinda una charla tecnica y luego equipamiento de seguridad. Desde los corrales hacia el sur se atraviesa el cañadon del arrollo Calafate. Luego de una hora y media de cabalgata se podra disfrutar de un almuerzo campero dentro de la cueva del arrollo',
        englishDesc: 'Cabalgata Experience is a horseback ride through the 25 de Mayo natural reserve where you can feel the immensity of the Patagonian fields, appreciate canyons, streams and stories of the southern gauchos. The starting point is the center of the 25 de Mayo ranch where a technical talk and safety equipment is given. From the corrals to the south you cross the Calafate canyon. After an hour and a half of horseback riding, you can enjoy a campestral lunch inside the Calafate stream cave.',
        src1: "cabal1",
        src2: "cabal2",
        src3: "cabal3",
    },
    {
        ...
        salidas: '9am / 4pm',
        precio: "$145000",
        link: 'https://walink.co/221f27',
        incluye: 'Traslado - 4x4 - Almuerzo',
        spanishDesc: 'En esta expedición de 4x4, accederemos a los lugares mas remotos de la Patagonia profunda, saliendo desde El Calafate hacia el sur y alcanzando puntos panorámicos desde los que contemplamos la inmensidad del paisaje, con vista a los cerros Verlika y Baguales que marcan el límite sur con Chile. Arrecifes de ostras fosilizadas, chenques inexplorados (enterratorios tehuelches), avistaje de fauna e interpretación de flora autóctona son algunas de las riquezas naturales queveremos en este Safari. Finalmente arribamos a La Sección de Estancia 25 de Mayo para un almuerzo o cena en una auténtica casa patagónica a 800 metros sobre el nivel del mar.',
        englishDesc: 'In this 4x4 expedition, we will access the most remote places of deep Patagonia, leaving from El Calafate towards the south and reaching panoramic points from which we contemplate the immensity of the landscape, with views of the Verlika and Baguales hills that mark the southern limit. with Chile. Fossilized oyster reefs, unexplored chenques (Tehuelche burial sites), wildlife viewing and interpretation of native flora are some of the natural riches that we will see on this Safari. Finally we arrive at Estancia 25 de Mayo Section for lunch or dinner in an authentic Patagonian house 800 meters above sea level.',
        src1: "safariEx1",
        src2: "safariEx2",
        src3: "safariEx3",
    },            
