...
export const DatosTours = [
    ...
    },
    {
        ...
        englishDesc: 'Cerro Frías 4x4 and Horseback Riding. 25km from El Calafate, you can choose to ascend Cerro Frías in a 4x4 to two panoramic points at 450 and 1,030 meters above sea level, including the balcony of the National Park, or take a horseback ride through meadows and forests, climbing the slopes of Cerro Frías. . On both excursions we will be able to appreciate views of Lago Argentino, Torres del Paine, Boca del Diablo and the highest peaks of the Andes Mountains and Cerro Fitz Roy, encountering wild and native animals of the area along the way. Upon returning we descend through our native lenga forest on the southeastern slope of Cerro Frías. "LUNCH- $48,000": PATAGONIAN STEW + DESSERT. VEGETARIAN MENU AVAILABLE (REQUEST IN ADVANCE). DRINKS NOT INCLUDED. "SNACK- $44,000": COFFEE, TEA OR CHOCOLATE & SWEET CAKES. "DINNER- $52,000": VEGETABLE SOUP + LAMB CASSEROLE + DESSERT',
        src1: "cerroFrias1",
        src2: "cerroFrias2",
        src3: "cerroFrias3",
    },    
