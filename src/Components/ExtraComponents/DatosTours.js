...
export const DatosTours = [
    ...
    },   
    {
        ...
        spanishDesc: 'La estancia 25 de mayo cuenta con 17000 hectareas de campo, y su antigua casco se encuentra ubicado a pasos del centro de El Calafate, un lugar ideal dende descansar y disfrutar del paisaje al pie del cerro calafate. Contamos con tres opciones: 1) "Tarde de Campo" donde podras disfrutar de un calido fogon con tortas fritas y cafe carretero, podras presenciar arreo de ovejas y trabajo de corrales, demostracion de esquila y caminata por el arroyo. A esta asctividad podras adicionar la opcion de cabalgata (No es necesario conocimiento previo). 2) "Tarde de Campo y Cena" Sumado a las actividades anteriores podras disfrutar de de una cena en "El Quincho" donde podras degustar cordero confitado, vino montañes, y la cena que incluye pan de campo, empanada criolla, cordero al asador, pollo, chorizo, papas rusticas y ensaladas. 3) "Cena Show" Esta opcion incluye solo la cena mencionada anteriormente.',
